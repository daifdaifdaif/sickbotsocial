...
$metadata = [
    ...
    'caption'  => '#sickbotsocial',

    // (optional) To add a hashtag, do this:
     'hashtags' => [
        // Note that you can add more than one hashtag in this array.
        [
             'tag_name'         => 'sickbotsocial', // Hashtag WITHOUT the '#'! NOTE: This hashtag MUST appear in the caption.
            'x'                => 0.5, // Range: 0.0 - 1.0. Note that x = 0.5 and y = 0.5 is center of screen.
             ...
             'width'            => 0.001, // Clickable area size, as percentage of image size: 0.0 - 1.0
             'height'           => 0.001, // ...
             'rotation'         => 0.0,
