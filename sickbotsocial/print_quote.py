...
def main_print_function(tweet=None, story=True, post=False):
	...
	if not run_offline:	
		...
		if story:
			os.system("php7.2 " + script_story + " "+ file_story + ">> /home/daif/jj-bot/php-log.txt")
		if post:
			os.system("php7.2 " + script_post + " "+ file + " \""+ tweet +" #sickbotsocial #dieyungenhurendothiv\" >> /home/daif/jj-bot/php-log.txt")
